...
/**
 * Subclass of {@link ClientConnectionSettings} to create connections using TCP as sub layer.
 * 
 * After creation, the local port is set to 4059 per default
 * 
 * @author Karsten Mueller-Bier
 */
public class TcpClientConnectionSettings extends ClientConnectionSettings<TcpClientConnectionSettings> {

	private int clientWPort;
	private int serverWPort;
	private InetSocketAddress serverAddress;
	private int localPort = 4059; // Default port for DLMS
	 ...
	 */
	public TcpClientConnectionSettings(InetSocketAddress serverAddress, int serverWPort, int clientWPort,
	 ...
	 */
	public TcpClientConnectionSettings setClientWPort(int wport) {
	 ...
	 *            Wrapper Port. Must be between 0 and 65536, both exclusive
	 */
	public TcpClientConnectionSettings setServerWPort(int wport) {
		if (wport < 0 || wport > 0xFFFF) {
			throw new IllegalArgumentException("WPort out of range (0, 65536)");
		}
		serverWPort = wport;
	 ...
	 */
	public TcpClientConnectionSettings setServerAddress(InetSocketAddress address) {
	 ...
	 *            The local port
	 */
	public TcpClientConnectionSettings setLocalPort(int port) {
	...
	public boolean equals(Object o) {
		if (o instanceof TcpClientConnectionSettings) {
			TcpClientConnectionSettings other = (TcpClientConnectionSettings) o;
